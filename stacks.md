...
**2.** We will assume that you have placed the raw sequencing data into the *raw/* directory. If you are using the raw files output by the BUSTARD part of the pipeline your dta will look like this:
...
After the last two steps, or workig directory should look like this:
